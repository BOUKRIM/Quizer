...
if(isset($_POST['submit'])){
    ...
    $insert = $conn->query($query) or die($conn->error.__LINE__); //true //false
            ...
            foreach($choices as $choice => $value){
                ...
                if($value != ''){
                    ...
                    //insertion choice table
                     ...
                     $inserted = $conn->query($query) or die($conn->error.__LINE__);
        ...
        <div class="container">
            ...
            <?php
               if(isset($message))
               {
                ...
                echo "<script>setTimeout(\"location.href='http://localhost/quizer/index.php';\",2000);</script>";
               }
